...
запуск программы ioclient.exe ip:port key_mask

в случае игнорирования второго и третьего аргумента, будут взяты стандартные значения ip, порта и маски ключа.
